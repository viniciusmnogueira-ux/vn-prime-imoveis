...
const SERVICOS = [
  {
    ...
    subtitle: 'Essencial, Plus ou Pro — anuncie por assinatura',
    desc: 'Publique seu imóvel na vitrine VN Prime com autonomia total. Escolha o plano conforme o número de imóveis e o nível de suporte que você precisa — sem pagar comissão.',
    bullets: ['Cadastro e gestão do anúncio em minutos', 'Qualificação de compradores pela plataforma', 'Leads com nome, e-mail e WhatsApp', 'Planos a partir de R$ 99/mês — sem comissão'],
...
const PLANOS = [
  {
    ...
    tag: 'R$ 99/mês',
    price: 'R$ 99',
    priceLabel: '/mês · 1 imóvel ativo · sem comissão',
    ...
    bullets: ['Até 1 imóvel ativo', 'Leads com nome, e-mail e WhatsApp', 'Descrição editorial gerada por IA', 'Endereço protegido — exibe só o bairro', 'Suporte por chat'],
    cta: 'Começar agora',
    img: 'https://images.unsplash.com/photo-1560518883-ce09059eeffa?w=1400&q=85',
  },
  {
    name: 'Plano Plus',
    tag: 'Mais popular · Até 3 imóveis',
    price: 'R$ 399',
    priceLabel: '/ 6 meses · até 3 imóveis ativos',
    desc: 'Para quem tem mais de um imóvel para anunciar. Curadoria VN Prime nos anúncios, análise de precificação por IA e relatório de desempenho mensal.',
    bullets: ['Até 3 imóveis ativos', 'Curadoria ativa dos anúncios', 'Análise de precificação por IA', 'Qualificação de leads antes do contato', 'Relatório de desempenho mensal'],
    cta: 'Escolher Plus',
    img: 'https://images.unsplash.com/photo-1556761175-5973dc0f32e7?w=1400&q=85',
  },
  {
    name: 'Plano Pro',
    tag: 'Para investidores · Até 10 imóveis',
    price: 'R$ 799',
    priceLabel: '/ 12 meses · até 10 imóveis ativos',
    desc: 'Estrutura completa para investidores com múltiplos imóveis. Painel gerencial, curadoria dedicada, relatórios mensais e suporte direto da equipe VN Prime.',
    bullets: ['Até 10 imóveis ativos', 'Painel gerencial consolidado', 'Curadoria dedicada em todos os anúncios', 'Relatório de mercado e benchmarks mensais', 'Suporte dedicado da equipe VN Prime'],
    cta: 'Assinar Pro',
...
const STATS = [
  ...
  { value: '3 planos', label: 'Essencial, Plus ou Pro' },
  { value: '0%', label: 'Comissão sobre a venda' },
            ...
            {([
              {
                ...
                custo: 'R$ 99/mês',
                subtitulo: '1 imóvel ativo — 0% de comissão sobre a venda',
                desc: 'Ideal para quem quer autonomia total. Você cadastra o imóvel, conduz as visitas e fecha direto com o comprador. A VN Prime garante a vitrine e a qualificação básica dos leads.',
                accent: '#6366F1',
              ...
              },
              {
                ...
                desc: 'A VN Prime qualifica compradores ativamente e mantém os anúncios otimizados. Você conduz as negociações com leads qualificados e acompanha pelo painel com relatório mensal.',
                accent: '#D4A857',
              ...
              },
              {
                ...
                desc: 'Estrutura completa para quem tem múltiplos imóveis. Painel gerencial consolidado, curadoria dedicada em cada anúncio, relatórios de mercado e suporte direto da equipe VN Prime.',
                accent: '#2F8674',
